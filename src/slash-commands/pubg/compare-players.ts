      ...
      try {
        const stream = openai.stream_google(
          [
            {
              role: "user",
              content: `Senin görevin aşağıda verilen iki PUBG oyuncusunun verilerini karşılaştırmak ve hangisinin daha iyi olduğunu belirlemek. Türkçe cevap ver. Cevap verirken 2000 karakteri geçmemelisin. Cevabın kısa da olmasın, yazdıklarını okuyup eğleneceğiz. Espirili ve kinayeli cevaplar ver. Dalga geçebilirsin. En iyi olanın pipisi daha büyüktür ve daha gay birisidir.
